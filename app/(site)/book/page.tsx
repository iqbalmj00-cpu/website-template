...
const BOOKING_FAQS = [
    { q: "What information do I need to book junk removal?", a: "Enter contact information, service type, load size, pickup address, access notes, schedule window, and quote review." },
    ...
    return (
        <>
            ...
            <PageHero
                ...
                lede={`Book junk removal with ${siteConfig.companyName} in ${cityState}. Enter the service type, load details, pickup address, access notes, schedule window, and quote review.`}
                hideTrustPanel
                primaryCta={{ label: "Get an Instant Quote", href: "#booking-wizard" }}
            />
